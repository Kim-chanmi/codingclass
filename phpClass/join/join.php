                    ...
                    <form action="joinSave.php" name="join" method="post">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="email" id="youEmail" name="youEmail" class="input_style1"
                                    placeholder="이메일을 적어주세요!" required>
                            </div>
                            <div>
                                <label for="youName">이름</label>
                                <input type="text" id="youName" name="youName" class="input_style1"
                                    placeholder="이름을 적어주세요!" required>
                            </div>
                            <div>
                                <label for="youPass">비밀번호</label>
                                <input type="password" id="youPass" name="youPass" class="input_style1"
                                    placeholder="비밀번호를 적어주세요!" required>
                            </div>
                            <div>
                                <label for="youPassC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" class="input_style1"
                                    placeholder="확인 비밀번호를 적어주세요!" required>
                            </div>
                            <div>
                                <label for="youPhone">휴대폰번호</label>
                                <input type="text" id="youPhone" name="youPhone" class="input_style1"
                                    placeholder="휴대폰번호를 적어주세요!" required>
                            </div>
