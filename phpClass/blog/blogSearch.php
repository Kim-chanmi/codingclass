            ...
            <div class="board__inner">
                <div class="board__title">
                    ...
                    <?php
                        ...
                        echo $sql;
                        $sql = "SELECT b.blogID, b.blogTitle, b.blogContents, m.youName, b.blogRegTime, b.blogView,b.blogImgSrc,b.blogCategory FROM myBlog b JOIN myMember m ON(b.memberID = m.myMemberID) ";
                        switch($searchOption) {
                            case "title":
                    ...
                    ?>
                    <a href="blog.php"
                        style="border:1px solid #000; position:absolute; left: 3px; top:214px; border-radius:20px; padding:5px 10px;">돌아가기</a>
                </div>
