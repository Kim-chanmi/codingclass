                    ...
                    <form name="login" action="loginSave.php" method="post">
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="email" name="youEmail" id="youEmail" class="input_style1" placeholder="이메일"
                                    class="input__style" required>
                            </div>
                            <div>
                                <label class="blind" for="youPass">비밀번호</label>
                                <input type="password" name="youPass" id="youPass" class="input_style1"
                                    placeholder="비밀번호" class="input__style" required>
                            </div>
