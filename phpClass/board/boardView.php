                    ...
                    <table>
                        ...
                        <tbody>
                            <?php
                                ...
                                $sql = "SELECT b.boardTitle, m.youName, b.regTime, b.boardView, b.boardContents FROM myBoard b JOIN myMember m ON(m.myMemberID = b.memberID) WHERE b.boardID = {$boardID};";
